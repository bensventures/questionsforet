---
titre: Le vrai problème du pin noir n'est pas qu'il brûle
chapo: >-
  On reproche souvent aux plantations de pin noir d'être des torches. La
  recherche raconte quelque chose de plus dérangeant : ce pin ne brûle pas plus
  qu'un autre, mais après un grand feu, il ne revient pas.
verdict: >-
  Le risque n'est pas l'inflammabilité de l'essence, c'est la densité des
  peuplements et leur incapacité à se régénérer après un feu sévère.
publie: 2026-07-25
themes:
  - essences
  - post-incendie
...
plantations de pins auraient rendu nos montagnes plus inflammables, et le pin
noir d'Autriche, planté par dizaines de milliers d'hectares, serait un coupable
tout désigné. L'accusation contient une part de vrai, mais elle vise la mauvaise
cible.

## Ce pin ne brûle pas « à cause de la résine »
...
Son point faible propre est ailleurs : sa litière se décompose mal et
s'accumule. [[cite:revertegat-2025-vulnefeu]]
...
Reste une question qu'on ne peut trancher qu'avec des données locales : ces
plantations sont-elles en train de se transformer en forêts plus mélangées, donc
plus résilientes, ou restent-elles des peuplements denses et fragiles ? Une
analyse des relevés de l'Inventaire forestier national sur le Pays Diois apporte
...
ces forêts se densifient en pins plus qu'elles ne se diversifient. [[cite:gilloz-2026-ifn-diois]]

<figure class="figure">
  <img
    src="/figures/a3_recrutement.png"
    width="936"
    height="546"
    alt="Comparaison du recrutement des pins et des feuillus dans les pinèdes échantillonnées du Pays Diois sur cinq ans ; les pins progressent environ deux fois plus vite."
  />
  <figcaption>
...
Le procès en inflammabilité rate donc sa cible. Le risque que porte le pin noir
...
Il faut enfin rappeler ce que le pin noir a remplacé. Il n'a pas pris la place
d'une chênaie, mais de versants mis à nu par des siècles de surpâturage et de
coupe, déboisés à leur paroxysme vers 1850. [[cite:metailie-savoir-bruler]] Ces
plantations ont d'abord été un outil de restauration des terrains de
montagne. [[cite:fady-perret-2020-pin-noir]]
...
de savoir s'il fallait planter, mais comment faire évoluer ces peuplements
aujourd'hui : les diversifier et les desserrer avant qu'un grand feu ne les
emporte, plutôt que les raser ou les laisser en l'état.

---

*Cette page s'appuie sur une analyse personnelle des données IFN du Pays Diois,
publiée en accès ouvert et reproductible. Il s'agit d'un travail de première main
non revu par les pairs : les chiffres cités sont des dénombrements d'échantillon,
sans valeur d'inventaire à l'échelle du territoire. Elle ne remplace ni un
diagnostic de terrain ni l'expertise des services forestiers et de secours
compétents.*